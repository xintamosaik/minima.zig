...
pub fn render() void {
    ...
    font.drawString(24, 8 * 1, "                                  ", colors.C64_BLACK, colors.C64_PURPLE);
    font.drawString(24, 8 * 2, " options                          ", colors.C64_BLACK, colors.C64_PURPLE);
    font.drawString(24, 8 * 3, "                                  ", colors.C64_BLACK, colors.C64_PURPLE);
