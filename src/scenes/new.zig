...
pub fn render() void {
    ...
    font.drawString(24, 8 * 1, "                                  ", colors.C64_BLACK, colors.C64_GREEN);
    font.drawString(24, 8 * 2, " new game                         ", colors.C64_BLACK, colors.C64_GREEN);
    font.drawString(24, 8 * 3, "                                  ", colors.C64_BLACK, colors.C64_GREEN);
